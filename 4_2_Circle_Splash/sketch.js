...
// ADD CIRCLE: Add one circle based on distance from other circles
function addCircle() {
    // Here's a new circle
...
function Circle(x, y, r) {
  // Initialising members of the circle object
  this.growing = true;
  this.x = x;
  this.y = y;
  this.r = r;
...
// EDGES: Check if a circle is stuck to an edges 
...
//GROW: Gows the circles radius. Play with this to get different sized circles.
Circle.prototype.grow = function () {
    this.r += 3.3;
}

// NEW TEXTURE: allocates a new id number  to get a new texture
Circle.prototype.newTexture = function() {
    this.num = int(random(0, img.length - 1));
}

// SHOW: draws the circle
