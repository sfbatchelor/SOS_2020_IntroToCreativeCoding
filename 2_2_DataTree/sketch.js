...
let branchXRange = 500;
let branchYRange = 800;
let maxLeaves = 30;
let minLeaves = 1;
let leafRange = 500;
let leafMaxWidth= 10;
...
// MAP: Small helper function used to remap a number from one value range to another.
...
//// DRAW DATA TREE: Function encapsulating the drawing of the actual tree.
